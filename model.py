...
class AE3(nn.Module):
    ...
    def forward(self, x):
        ...
        #  Ajuste de dimensiones para la GRU
        ...
        for i in range(targets_encoded.size(2)):  # Iterate over frames to predict
            ...
            if self.train:
                ...
                if mse_error.item() > 0.024:  # If error is too high, use the real frame
    ...
    def update_scheduled_sampling(self):
        """ 🔹 Actualiza la probabilidad de usar predicciones previas en `Scheduled Sampling` """
